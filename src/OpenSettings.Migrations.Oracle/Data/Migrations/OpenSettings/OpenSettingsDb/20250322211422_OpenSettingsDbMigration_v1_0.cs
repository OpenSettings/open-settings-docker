        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReferenceId = table.Column<string>(type: "NVARCHAR2(2000)", nullable: true),
                    ReferenceIdLowercase = table.Column<string>(type: "NVARCHAR2(450)", nullable: true),
                    Features = table.Column<string>(type: "NVARCHAR2(2000)", nullable: true),
                    ExpiryDate = table.Column<DateTime>(type: "TIMESTAMP(7)", nullable: true),
                    IsExpired = table.Column<bool>(type: "NUMBER(1)", nullable: false),
                    ExpiredOn = table.Column<DateTime>(type: "TIMESTAMP(7)", nullable: true),
                    IsRevoked = table.Column<bool>(type: "NUMBER(1)", nullable: false),
                    RevokedOn = table.Column<DateTime>(type: "TIMESTAMP(7)", nullable: true),
                    Key = table.Column<string>(type: "NVARCHAR2(2000)", nullable: true),
                    Holder = table.Column<string>(type: "NVARCHAR2(2000)", nullable: true),
                    HolderLowercase = table.Column<string>(type: "NVARCHAR2(450)", nullable: true),
                    Edition = table.Column<int>(type: "NUMBER(10)", nullable: false),
                    IssuedAt = table.Column<DateTime>(type: "TIMESTAMP(7)", nullable: false),
                    NotBefore = table.Column<DateTime>(type: "TIMESTAMP(7)", nullable: false),
                    CreatedOn = table.Column<DateTime>(type: "TIMESTAMP(7)", nullable: false),
                    UpdatedOn = table.Column<DateTime>(type: "TIMESTAMP(7)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Owner = table.Column<string>(type: "NVARCHAR2(100)", maxLength: 100, nullable: true),
                    ExpiryTime = table.Column<DateTime>(type: "TIMESTAMP(7)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TypeLowercase = table.Column<string>(type: "NVARCHAR2(2000)", nullable: true),
                    Value = table.Column<string>(type: "NVARCHAR2(2000)", nullable: true),
                    ValueLowercase = table.Column<string>(type: "NVARCHAR2(2000)", nullable: true),
                    Slug = table.Column<string>(type: "NVARCHAR2(450)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NameLowercase = table.Column<string>(type: "NVARCHAR2(2000)", nullable: true),
                    Slug = table.Column<string>(type: "NVARCHAR2(450)", nullable: true),
                    CreatedOn = table.Column<DateTime>(type: "TIMESTAMP(7)", nullable: false),
                    UpdatedOn = table.Column<DateTime>(type: "TIMESTAMP(7)", nullable: true)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AuthScheme = table.Column<string>(type: "NVARCHAR2(2000)", nullable: true),
                    OAuthProvider = table.Column<string>(type: "NVARCHAR2(2000)", nullable: true),
                    ProviderId = table.Column<string>(type: "NVARCHAR2(2000)", nullable: true),
                    Email = table.Column<string>(type: "NVARCHAR2(2000)", nullable: true),
                    EmailLowercase = table.Column<string>(type: "NVARCHAR2(2000)", nullable: true),
                    Username = table.Column<string>(type: "NVARCHAR2(2000)", nullable: true),
                    UsernameLowercase = table.Column<string>(type: "NVARCHAR2(2000)", nullable: true),
                    ...
                    Initials = table.Column<string>(type: "NVARCHAR2(2000)", nullable: true),
                    LastLogin = table.Column<DateTime>(type: "TIMESTAMP(7)", nullable: false),
                    IsActive = table.Column<bool>(type: "NUMBER(1)", nullable: false),
                    RowVersion = table.Column<byte[]>(type: "RAW(2000)", nullable: true),
                    CreatedOn = table.Column<DateTime>(type: "TIMESTAMP(7)", nullable: false),
                    UpdatedOn = table.Column<DateTime>(type: "TIMESTAMP(7)", nullable: true)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "NUMBER(10)", nullable: false)
                        .Annotation("Oracle:Identity", "START WITH 1 INCREMENT BY 1"),
                    Name = table.Column<string>(type: "NVARCHAR2(2000)", nullable: true),
                    NameLowercase = table.Column<string>(type: "NVARCHAR2(450)", nullable: true),
                    Slug = table.Column<string>(type: "NVARCHAR2(450)", nullable: true),
                    CreatedById = table.Column<Guid>(type: "RAW(16)", nullable: true),
                    UpdatedById = table.Column<Guid>(type: "RAW(16)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExpiresIn = table.Column<TimeSpan>(type: "INTERVAL DAY(8) TO SECOND(7)", nullable: true),
                    IsExpired = table.Column<bool>(type: "NUMBER(1)", nullable: false),
                    ExpiredOn = table.Column<DateTime>(type: "TIMESTAMP(7)", nullable: true),
                    CreatorName = table.Column<string>(type: "NVARCHAR2(2000)", nullable: true),
                    CreatedById = table.Column<Guid>(type: "RAW(16)", nullable: true),
                    UpdatedById = table.Column<Guid>(type: "RAW(16)", nullable: true),
                    CreatedOn = table.Column<DateTime>(type: "TIMESTAMP(7)", nullable: false),
                    UpdatedOn = table.Column<DateTime>(type: "TIMESTAMP(7)", nullable: true)
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "NUMBER(10)", nullable: false)
                        .Annotation("Oracle:Identity", "START WITH 1 INCREMENT BY 1"),
                    DisplayName = table.Column<string>(type: "NVARCHAR2(2000)", nullable: true),
                    DisplayNameLowercase = table.Column<string>(type: "NVARCHAR2(2000)", nullable: true),
                    ClientName = table.Column<string>(type: "NVARCHAR2(2000)", nullable: true),
                    ClientNameLowercase = table.Column<string>(type: "NVARCHAR2(450)", nullable: true),
                    Slug = table.Column<string>(type: "NVARCHAR2(450)", nullable: true),
                    ClientId = table.Column<Guid>(type: "RAW(16)", nullable: false),
                    ClientIdLowercase = table.Column<string>(type: "NVARCHAR2(2000)", nullable: true),
                    HashedClientSecret = table.Column<string>(type: "NVARCHAR2(2000)", nullable: true),
                    Description = table.Column<string>(type: "NVARCHAR2(2000)", nullable: true),
                    ImageUrl = table.Column<string>(type: "NVARCHAR2(2000)", nullable: true),
                    WikiUrl = table.Column<string>(type: "NVARCHAR2(2000)", nullable: true),
                    Type = table.Column<int>(type: "NUMBER(10)", nullable: false),
                    GroupId = table.Column<int>(type: "NUMBER(10)", nullable: true),
                    CreatedById = table.Column<Guid>(type: "RAW(16)", nullable: true),
                    UpdatedById = table.Column<Guid>(type: "RAW(16)", nullable: true),
                    SortOrder = table.Column<int>(type: "NUMBER(10)", nullable: false),
                    RowVersion = table.Column<byte[]>(type: "RAW(2000)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    GroupId = table.Column<int>(type: "NUMBER(10)", nullable: false),
                    NotificationId = table.Column<Guid>(type: "RAW(16)", nullable: false),
                    CreatedById = table.Column<Guid>(type: "RAW(16)", nullable: true),
                    CreatedOn = table.Column<DateTime>(type: "TIMESTAMP(7)", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NotificationId = table.Column<Guid>(type: "RAW(16)", nullable: false),
                    CreatedById = table.Column<Guid>(type: "RAW(16)", nullable: true),
                    IsOpened = table.Column<bool>(type: "NUMBER(1)", nullable: false),
                    OpenedOn = table.Column<DateTime>(type: "TIMESTAMP(7)", nullable: true),
                    IsViewed = table.Column<bool>(type: "NUMBER(1)", nullable: false),
                    ViewedOn = table.Column<DateTime>(type: "TIMESTAMP(7)", nullable: true),
                    IsDismissed = table.Column<bool>(type: "NUMBER(1)", nullable: false),
                    DismissedOn = table.Column<DateTime>(type: "TIMESTAMP(7)", nullable: true),
                    CreatedOn = table.Column<DateTime>(type: "TIMESTAMP(7)", nullable: false),
                    UpdatedOn = table.Column<DateTime>(type: "TIMESTAMP(7)", nullable: true)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    AppId = table.Column<int>(type: "NUMBER(10)", nullable: false),
                    IdentifierId = table.Column<int>(type: "NUMBER(10)", nullable: false),
                    SortOrder = table.Column<int>(type: "NUMBER(10)", nullable: false),
                    CreatedById = table.Column<Guid>(type: "RAW(16)", nullable: true),
                    UpdatedById = table.Column<Guid>(type: "RAW(16)", nullable: true),
                    RowVersion = table.Column<byte[]>(type: "RAW(2000)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "NUMBER(10)", nullable: false)
                        .Annotation("Oracle:Identity", "START WITH 1 INCREMENT BY 1"),
                    StoreInSeparateFile = table.Column<bool>(type: "NUMBER(1)", nullable: false),
                    IgnoreIndividualStoreInSeparateFile = table.Column<bool>(type: "NUMBER(1)", nullable: false),
                    IgnoreOnFileChange = table.Column<bool>(type: "NUMBER(1)", nullable: false),
                    IgnoreIndividualIgnoreOnFileChange = table.Column<bool>(type: "NUMBER(1)", nullable: false),
                    RegistrationMode = table.Column<int>(type: "NUMBER(10)", nullable: false),
                    IgnoreIndividualRegistrationMode = table.Column<bool>(type: "NUMBER(1)", nullable: false),
                    Consumer = table.Column<string>(type: "NVARCHAR2(2000)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NameLowercase = table.Column<string>(type: "NVARCHAR2(450)", nullable: true),
                    Slug = table.Column<string>(type: "NVARCHAR2(450)", nullable: true),
                    DynamicId = table.Column<string>(type: "NVARCHAR2(2000)", nullable: true),
                    Urls = table.Column<string>(type: "NVARCHAR2(2000)", nullable: true),
                    ...
                    MachineName = table.Column<string>(type: "NVARCHAR2(2000)", nullable: true),
                    Environment = table.Column<string>(type: "NVARCHAR2(2000)", nullable: true),
                    ReloadStrategies = table.Column<string>(type: "NVARCHAR2(2000)", nullable: true),
                    ServiceType = table.Column<int>(type: "NUMBER(10)", nullable: false),
                    DataAccessType = table.Column<int>(type: "NUMBER(10)", nullable: true),
                    AppId = table.Column<int>(type: "NUMBER(10)", nullable: false),
                    IdentifierId = table.Column<int>(type: "NUMBER(10)", nullable: false),
                    CreatedOn = table.Column<DateTime>(type: "TIMESTAMP(7)", nullable: false),
                    UpdatedOn = table.Column<DateTime>(type: "TIMESTAMP(7)", nullable: true)
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ComputedIdentifier = table.Column<Guid>(type: "RAW(16)", nullable: false),
                    SerializerType = table.Column<int>(type: "NUMBER(10)", nullable: false),
                    CompressionType = table.Column<int>(type: "NUMBER(10)", nullable: false),
                    CompressionLevel = table.Column<int>(type: "NUMBER(10)", nullable: false),
                    Version = table.Column<string>(type: "NVARCHAR2(2000)", nullable: true),
                    DataRestored = table.Column<bool>(type: "NUMBER(1)", nullable: false),
                    DataValidationDisabled = table.Column<bool>(type: "NUMBER(1)", nullable: false),
                    StoreInSeparateFile = table.Column<bool>(type: "NUMBER(1)", nullable: false),
                    IgnoreOnFileChange = table.Column<bool>(type: "NUMBER(1)", nullable: true),
                    RegistrationMode = table.Column<int>(type: "NUMBER(10)", nullable: false),
                    IsDraft = table.Column<bool>(type: "NUMBER(1)", nullable: false),
                    IsCopied = table.Column<bool>(type: "NUMBER(1)", nullable: false),
                    CopiedOn = table.Column<DateTime>(type: "TIMESTAMP(7)", nullable: true),
                    IdentifierId = table.Column<int>(type: "NUMBER(10)", nullable: false),
                    AppId = table.Column<int>(type: "NUMBER(10)", nullable: false),
                    CopiedFromId = table.Column<int>(type: "NUMBER(10)", nullable: true),
                    CreatedById = table.Column<Guid>(type: "RAW(16)", nullable: true),
                    UpdatedById = table.Column<Guid>(type: "RAW(16)", nullable: true),
                    RowVersion = table.Column<byte[]>(type: "RAW(2000)", nullable: true),
                    CreatedOn = table.Column<DateTime>(type: "TIMESTAMP(7)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "NUMBER(10)", nullable: false)
                        .Annotation("Oracle:Identity", "START WITH 1 INCREMENT BY 1"),
                    Identifier = table.Column<Guid>(type: "RAW(16)", nullable: false),
                    Name = table.Column<string>(type: "NVARCHAR2(2000)", nullable: true),
                    FullName = table.Column<string>(type: "NVARCHAR2(2000)", nullable: true),
                    Namespace = table.Column<string>(type: "NVARCHAR2(2000)", nullable: true),
                    SettingId = table.Column<int>(type: "NUMBER(10)", nullable: false),
                    CreatedById = table.Column<Guid>(type: "RAW(16)", nullable: true),
                    UpdatedById = table.Column<Guid>(type: "RAW(16)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CompressionType = table.Column<int>(type: "NUMBER(10)", nullable: false),
                    CompressionLevel = table.Column<int>(type: "NUMBER(10)", nullable: false),
                    Version = table.Column<string>(type: "NVARCHAR2(450)", nullable: true),
                    Slug = table.Column<string>(type: "NVARCHAR2(450)", nullable: true),
                    SettingId = table.Column<int>(type: "NUMBER(10)", nullable: false),
                    CreatedById = table.Column<Guid>(type: "RAW(16)", nullable: true),
                    RestoredById = table.Column<Guid>(type: "RAW(16)", nullable: true),
                    RowVersion = table.Column<byte[]>(type: "RAW(2000)", nullable: true),
                    CreatedOn = table.Column<DateTime>(type: "TIMESTAMP(7)", nullable: false),
                    UpdatedOn = table.Column<DateTime>(type: "TIMESTAMP(7)", nullable: true)
                },
